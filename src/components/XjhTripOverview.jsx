    ...
    return(
        <div className='outer-container'>
            <div className='overview'>
                <h2>Overview</h2>
                <p className="dot-before">Cultural Collision: Immerse in the fusion of Chinese and Western cultures in Shanghai's former French Concession.</p>
                <p className="dot-before">Historical Landmarks: Journey past the former Far East's largest cathedral and one of China's most expensive Buddhist temples.</p>
                <p className="dot-before">Architectural Tales: Discover dozens of protected historical buildings with intriguing, lesser-known stories.</p>
                <p className="dot-before">Intimate Experience: Limited to 10 participants for a more personal and engaging tour.</p>
                <p className="dot-before">Inclusive Amenities: Water and food included, with options to accommodate dietary preferences</p>
                <p className="dot-before">Culinary Finale: Conclude the day with a taste of authentic Shanghai cuisine.</p>
